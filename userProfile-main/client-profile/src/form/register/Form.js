...
<div class="form-group">
  <label htmlfor="sel1">Select your Qualification:</label><br></br>
...
<br/>
<div><br/>
<textarea class="form-control " placeholder='enter your address' onChange={formik.handleChange} 
...
<button class="btn btn-success" >Submit</button>
    ...
    <p className="option">If you already have an account <Link to="login">Login</Link></p>
        </div>
    </div>
  )
}
